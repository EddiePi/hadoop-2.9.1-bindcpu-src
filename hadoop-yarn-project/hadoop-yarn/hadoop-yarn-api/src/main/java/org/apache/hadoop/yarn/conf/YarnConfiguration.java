...
public class YarnConfiguration extends Configuration {
  ...
  /** Edit by Eddie */
  /** taskset related configuration*/
  public static final String TOTAL_PHYSICAL_CORE = NM_PREFIX + "total-physical-core";
  public static final String AVAILABLE_CORE_SET = NM_PREFIX + "available-core-set";
